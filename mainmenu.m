...
% Last Modified by GUIDE v2.5 13-Dec-2018 18:02:10
...
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
sticks1; %opens player vs player game%
close(mainmenu); %closes current gui%
...
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
sticks2; %opens player vs computer game%
close(mainmenu); %closes current gui%